...
songplay_table_create = "CREATE TABLE songplays (songplay_id bigserial PRIMARY KEY, start_time timestamp NOT NULL,                                                                                              user_id bigint NOT NULL,                                                                                                    level varchar,                                                                                                              song_id varchar,                                                                                                            artist_id varchar,                                                                                                          session_id bigint,                                                                                                          location varchar,                                                                                                            user_agent varchar)"

user_table_create = "CREATE TABLE users (user_id bigint PRIMARY KEY,                                                                                                  first_name varchar,                                                                                                          last_name varchar,                                                                                                          gender char,                                                                                                                level varchar)"

song_table_create = "CREATE TABLE songs (song_id varchar PRIMARY KEY,                                                                                                title varchar NOT NULL,                                                                                                      artist_id varchar NOT NULL,                                                                                                  year int,                                                                                                                    duration NUMERIC(12, 7))"

artist_table_create = "CREATE TABLE artists (artist_id varchar PRIMARY KEY,                                                                                              name varchar NOT NULL,                                                                                                      location varchar,                                                                                                            latitude NUMERIC(12, 7),                                                                                                    longitude NUMERIC(12, 7))"
